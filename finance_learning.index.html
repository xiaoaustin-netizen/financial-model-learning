...
/* Ladder rail: each button has a left border that forms a continuous rail */
div[data-testid="stSidebar"] .stButton { margin:0; padding:0 8px 1px; }
div[data-testid="stSidebar"] .stButton button {
    width:100%; text-align:left;
    border-radius:0 !important; border:none; outline:none; box-shadow:none !important;
    font-size:.82rem; font-weight:500;
    padding:8px 12px 8px 14px; margin:0; line-height:1.3;
    background:#E5E7EB !important; color:#1E3A5F !important;
    border-left:3px solid #D1D5DB;
}
div[data-testid="stSidebar"] .stButton button p { color:#1E3A5F !important; }
div[data-testid="stSidebar"] .stButton button:hover {
    background:#D1D5DB !important; color:#1E3A5F !important;
    border-left-color:#6B7280;
}
div[data-testid="stSidebar"] .stButton button:hover p { color:#1E3A5F !important; }
div[data-testid="stSidebar"] .stButton button[kind="primary"] {
    background:#D1D5DB !important; color:#1E3A5F !important; font-weight:700;
    border-left-color:#1E3A5F;
}
div[data-testid="stSidebar"] .stButton button[kind="primary"] p {
    color:#1E3A5F !important; font-weight:700;
}
...
def page_header(page):
    ...
    chips = "".join(
        f'<span class="mod-stat">'
        f'<span class="mod-stat-label">{lbl}</span>{val}'
        f'</span>'
    ...
    with col_hdr:
        st.markdown(
            ...
            f'<span style="font-size:.62rem;color:#9CA3AF;margin-right:8px;white-space:nowrap;">'
            f'{co["name"]} &middot; {co["sector"]}</span>{chips}'
            f'</div>'
            f'</div>',
